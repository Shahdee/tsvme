   ...
   class DicomDictionary
    {
        public Dictionary<string, string>dict = new Dictionary<string,string>()
        {
            ...
            {"00189321", "SQCT Exporsure Sequence Di"},
            {"00189322", "FDReconstruction Pixel Spacing"},    
            {"00189323", "CSExposure Modulation Type"}, 
            {"0189324", "FDEstimated Dose Saving EstimatedDoseSaving"}, 
            {"00189325", "SQCT X-Ray Details Sequence CTXRayDetailsSequence"},  
            {"00189326", "SQCT Position Sequence CTPositionSequence"},
            {"00189327", "FDTable Position TablePosition"},  
            {"00189328", "FDExposure Time in ms ExposureTimeInms"},
            ...
            {"20300010", "USAnnotationPosition"},  
            {"20300020", "LOTextString"},  
            ...
            {"7FE00010", "OBPixel Data"}, // exactly that i realy need to get
